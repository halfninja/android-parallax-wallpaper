...
public class ParallaxWallpaper extends GLWallpaperService {
    ...
    public Engine onCreateEngine() {
    	Log.d(TAG, "Wallpaper engine created");
...
*/    
    ...
    class ParallaxEngine extends GLEngine implements OnSharedPreferenceChangeListener {
        ...
        public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
            ...
            try {
	            if (customPath != null && renderer != null) {
